...
type Options struct {
	...
	GroupFunc func(context.Context, func(*dispatch.Route) bool, func(*types.Alert, time.Time) bool, func(string) bool) (dispatch.AlertGroups, map[model.Fingerprint][]string, error)
